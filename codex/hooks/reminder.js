 ...
 *
 * Codex port note:
 * - Preserves upstream v1.3.0 reminder regexes and output text.
...
(async function main() {
  ...
  const userMessage = event.prompt || event.message || event.user_prompt || inputData || '';
  ...
  outputHook('UserPromptSubmit', reminder);
})();
